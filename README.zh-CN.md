...
本机 Windows x64 Release 构建（已包含 `ac59a3b` 引入的 compiled REC 常量共享）
在项目自带的 500×500 测试图上，
...
[本机配置及修改前后配对测量](docs/performance-baseline.md#compiled-rec-packed-constant-sharing-snapshot-2026-09-25)
