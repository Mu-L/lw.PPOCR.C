...
int main(int argc, char** argv) {
    ...
    double legacy_ms;
    double fast_ms;
    lw_x64_fast_profile fast_profile;
    ...
    printf("{\"width\":%u,\"legacy_ms\":%.6f,\"fast_ms\":%.6f,\"speedup\":%.6f,\"max_abs\":%.9g,\"mismatch\":%llu,\"argmax_mismatch\":%llu,\"fast_nodes\":%u,\"generic_nodes\":%u,\"pointwise_nodes\":%u,\"dense_nodes\":%u,\"depthwise_nodes\":%u,\"binary_nodes\":%u,\"relu_nodes\":%u,\"unary_nodes\":%u,\"reduce_mean_nodes\":%u,\"pool_nodes\":%u,\"concat_nodes\":%u,\"batch_norm_nodes\":%u,\"planner_conversion_count\":%u,\"unsupported_nhwc_node_count\":%u,\"conversion_count\":%llu,\"conversion_bytes\":%llu,\"nhwc_workspace_bytes\":%llu,\"fast_profile_total_ns\":%llu,\"fast_profile_conversion_invocations\":%llu,\"fast_profile_conversion_bytes\":%llu,\"profile_pointwise_ns\":%llu,\"profile_dense_ns\":%llu,\"profile_depthwise_ns\":%llu,\"profile_unary_ns\":%llu,\"profile_binary_ns\":%llu,\"profile_batch_norm_ns\":%llu,\"profile_reduce_mean_ns\":%llu,\"profile_pool_ns\":%llu,\"profile_concat_ns\":%llu,\"profile_gelu_ns\":%llu,\"physical_op_count\":%u,\"physical_generic_ops\":%u,\"elided_tensor_count\":%u,\"depthwise_x2_invocations\":%llu,\"depthwise_x1_invocations\":%llu,\"fused_conv_bn\":%u,\"fused_conv_relu\":%u,\"fused_conv_bn_relu\":%u,\"fused_conv_add\":%u,\"fused_conv_add_relu\":%u}\n",
           ...
           (unsigned long long)fast_profile.total_nanoseconds,
           (unsigned long long)fast_profile.conversion_invocations,
           (unsigned long long)fast_profile.conversion_bytes,
           (unsigned long long)fast_profile.kind_nanoseconds[LW_X64_FAST_NODE_POINTWISE],
           (unsigned long long)fast_profile.kind_nanoseconds[LW_X64_FAST_NODE_DENSE],
           (unsigned long long)fast_profile.kind_nanoseconds[LW_X64_FAST_NODE_DEPTHWISE],
           (unsigned long long)fast_profile.kind_nanoseconds[LW_X64_FAST_NODE_CONTIGUOUS_UNARY],
           (unsigned long long)fast_profile.kind_nanoseconds[LW_X64_FAST_NODE_CONTIGUOUS_BINARY],
           (unsigned long long)fast_profile.kind_nanoseconds[LW_X64_FAST_NODE_BATCH_NORM],
           (unsigned long long)fast_profile.kind_nanoseconds[LW_X64_FAST_NODE_REDUCE_MEAN],
           ...
           (unsigned long long)plan->depthwise_x2_invocations,
           (unsigned long long)plan->depthwise_x1_invocations,
